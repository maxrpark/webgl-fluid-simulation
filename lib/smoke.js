"use strict";
(window.hookBannerEffect = {}),
    (hookBannerEffect.isMobile = !1),
    (hookBannerEffect.pointer = null);
var canvas = document.getElementById("canvas-max");
...
var config = {
    ...
    PRESSURE_ITERATIONS: 53,
    CURL: 0,
    SPLAT_RADIUS: 0.0035,
}, pointers = [], splatStack = [], ref = getWebGLContext(canvas), gl = ref.gl, ext = ref.ext;
function getWebGLContext(e) {
    var r, t, n = { alpha: !0, depth: !1, stencil: !1, antialias: !1 }, i = e.getContext("webgl2", n), a = !!i;
    a || (i = e.getContext("webgl", n) || e.getContext("experimental-webgl", n)),
        a
            ? (i.getExtension("EXT_color_buffer_float"),
                (t = i.getExtension("OES_texture_float_linear")))
            : ((r = i.getExtension("OES_texture_half_float")),
                (t = i.getExtension("OES_texture_half_float_linear"))),
        i.clearColor(0, 0, 0, 0);
    var o, l, u, g = a ? i.HALF_FLOAT : r.HALF_FLOAT_OES;
    return (a
        ? ((o = getSupportedFormat(i, i.RGBA16F, i.RGBA, g)),
            (l = getSupportedFormat(i, i.RG16F, i.RG, g)),
            (u = getSupportedFormat(i, i.R16F, i.RED, g)))
        : ((o = getSupportedFormat(i, i.RGBA, i.RGBA, g)),
            (l = getSupportedFormat(i, i.RGBA, i.RGBA, g)),
            (u = getSupportedFormat(i, i.RGBA, i.RGBA, g))),
...
var GLProgram = function (e, r) {
    if (((this.uniforms = {}),
        ...
        gl.attachShader(this.program, r),
...
function initFramebuffers() {
    ...
    var e = ext.halfFloatTexType, r = ext.formatRGBA, t = ext.formatRG, n = ext.formatR;
...
function createFBO(e, r, t, n, i, a, o) {
    ...
    gl.bindTexture(gl.TEXTURE_2D, l),
        ...
        gl.texImage2D(gl.TEXTURE_2D, 0, n, r, t, 0, i, a, null);
    var u = gl.createFramebuffer();
    return (gl.bindFramebuffer(gl.FRAMEBUFFER, u),
        gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_2D, l, 0),
        gl.viewport(0, 0, r, t),
        gl.clear(gl.COLOR_BUFFER_BIT),
        [l, u, e]);
}
function createDoubleFBO(e, r, t, n, i, a, o) {
    var l = createFBO(e, r, t, n, i, a, o), u = createFBO(e + 1, r, t, n, i, a, o);
    return {
        get read() {
            return l;
        },
...
var blit = (gl.bindBuffer(gl.ARRAY_BUFFER, gl.createBuffer()),
...
function update() {
    ...
    for (var r = 0; r < pointers.length; r++) {
        var t = pointers[r];
        (t.moved || !0 === hookBannerEffect.isMobile) &&
            (splat(t.x, t.y, t.dx, t.dy, t.color), (t.moved = !1));
    }
    curlProgram.bind(),
...
multipleSplats(parseInt(20 * Math.random()) + 5),
    ...
    canvas.addEventListener("mousemove", function (e) {
        if (!0 === hookBannerEffect.isMobile)
            return null;
        (pointers[0].moved = pointers[0].down),
            (pointers[0].dx = 10 * (e.offsetX - pointers[0].x)),
            (pointers[0].dy = 10 * (e.offsetY - pointers[0].y)),
            (pointers[0].x = e.offsetX),
            (pointers[0].y = e.offsetY);
    }),
    canvas.addEventListener("touchmove", function (e) {
        if ((e.preventDefault(), !0 === hookBannerEffect.isMobile))
            return null;
        for (var r = e.targetTouches, t = 0; t < r.length && !(t > 0); t++) {
            var n = pointers[t];
            (n.moved = n.down),
                (n.dx = 10 * (r[t].pageX - n.x)),
                (n.dy = 10 * (r[t].pageY - n.y)),
                (n.x = r[t].pageX),
                (n.y = r[t].pageY);
        }
    }, !1),
    canvas.addEventListener("touchstart", function (e) {
        ...
        for (var r = e.targetTouches, t = 0; t < r.length; t++) {
            t >= pointers.length && pointers.push(new pointerPrototype()),
                (pointers[t].id = r[t].identifier),
                (pointers[t].down = !0),
                (pointers[t].x = r[t].pageX),
                (pointers[t].y = r[t].pageY);
            Math.random(), Math.random(), Math.random();
            pointers[t].color = [0.44, 0, 0.9];
        }
    }),
    window.addEventListener("mouseup", function () { }),
    window.addEventListener("touchend", function (e) {
        for (var r = e.changedTouches, t = 0; t < r.length; t++)
            for (var n = 0; n < pointers.length; n++)
                r[t].identifier == pointers[n].id && (pointers[n].down = !1);
    }),
    (pointers[0].down = !0);
var color = [Math.random() + 0.2, Math.random() + 0.2, Math.random() + 0.2];
color = [0, 0, 0];
(pointers[0].color = color),
    (hookBannerEffect.pointer = pointers[0]),
    (window.myPointer = window.innerWidth / 2);
