...
var Material = /** @class */ (function () {
    function Material(vertexShader) {
        ...
        this.ditheringTexture = this.createTextureAsync("package/assets/LDR_LLL1_0.png"); // TODO
    ...
    Material.prototype.setKeywords = function (keywords) {
        ...
        if (program == null) {
            var fragmentShader = new ShaderCompiler(this.gl.FRAGMENT_SHADER, // TODO
    ...
    Material.prototype.drawDisplay = function (target) {
        ...
        this.gl.uniform1i(this.uniforms.uTexture, this.fluidSimulation.webGLContext.dye.read.attach(0));
        if (config.BLOOM) {
            this.gl.uniform1i(this.uniforms.uBloom, this.fluidSimulation.webGLContext.bloom.attach(1));
        ...
        if (config.SUNRAYS)
            this.gl.uniform1i(this.uniforms.uSunrays, this.fluidSimulation.webGLContext.sunrays.attach(3));
