...
var Material = /** @class */ (function () {
    function Material(props) {
        ...
        this.ditheringTexture = this.createTextureAsync("node_modules/fluid-webgl/assets/LDR_LLL1_0.png");
    ...
    Material.prototype.createFragmentShader = function (keywords) {
        ...
        if (this.program == null) {
            var fragmentShader_1 = new ShaderCompiler(this.webGLContext, shaderType.FRAGMENT, this.fragmentShaderSource, keywords);
