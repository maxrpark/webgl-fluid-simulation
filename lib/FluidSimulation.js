...
import { normalizeColor, setFluidColor, uuid, wrap, } from "./utils/helperFunc.js";
...
var FluidSimulation = /** @class */ (function () {
    ...
    FluidSimulation.prototype.multipleSplats = function (amount) {
        for (var i = 0; i < amount; i++) {
            var color_1 = setFluidColor(this.config.fluidColor);
            color_1.r *= 10.0;
            color_1.g *= 10.0;
            color_1.b *= 10.0;
            var x = Math.random();
    ...
    FluidSimulation.prototype.updateColors = function (dt) {
        ...
        if (this.colorUpdateTimer >= 1) {
            ...
            this.pointers.forEach(function (p) {
                p.color = setFluidColor(_this.config.fluidColor);
            });
        }
    };
