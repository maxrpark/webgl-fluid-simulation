...
var FluidSimulation = /** @class */ (function () {
    ...
    FluidSimulation.prototype.applyBloom = function (source, destination) {
        ...
        this.gl.uniform1f(this.bloomPrefilterProgram.uniforms.threshold, config.BLOOM_THRESHOLD);
        ...
        this.gl.uniform1f(this.bloomFinalProgram.uniforms.intensity, config.BLOOM_INTENSITY);
    ...
    FluidSimulation.prototype.applySunrays = function (source, mask, destination) {
        ...
        this.gl.uniform1f(this.sunraysProgram.uniforms.weight, config.SUNRAYS_WEIGHT);
