...
var WebGLContext = /** @class */ (function () {
    ...
    WebGLContext.prototype.resizeFBO = function (target, w, h, internalFormat, format, type, param) {
        ...
        this.gl.uniform1i(this.fluidSimulation.copyProgram.uniforms.uTexture, target.attach(0));
        this.blit(newFBO);
        return newFBO;
    };
    ...
    WebGLContext.prototype.initFramebuffers = function () {
        var simRes = this.getResolution(this.fluidSimulation.config.simResolution);
        var dyeRes = this.getResolution(this.fluidSimulation.config.dyeResolution);
    ...
    WebGLContext.prototype.initBloomFramebuffers = function () {
        var res = this.getResolution(this.fluidSimulation.config.BLOOM_RESOLUTION);
        var texType = this.ext.halfFloatTexType;
        var rgba = this.ext.formatRGBA;
        var filtering = this.ext.supportLinearFiltering
            ? this.gl.LINEAR
        ...
        for (var i = 0; i < this.fluidSimulation.config.BLOOM_ITERATIONS; i++) {
    ...
    WebGLContext.prototype.initSunraysFramebuffers = function () {
        var res = this.getResolution(this.fluidSimulation.config.SUNRAYS_RESOLUTION);
        var texType = this.ext.halfFloatTexType;
        var r = this.ext.formatR;
        var filtering = this.ext.supportLinearFiltering
            ? this.gl.LINEAR
